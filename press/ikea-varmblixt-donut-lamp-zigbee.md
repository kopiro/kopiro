...
In practice, this means the original mains power is converted from `230V AC` to `24V DC`, and then the controller handles switching and dimming on the low-voltage side. That is the only part I replaced.
